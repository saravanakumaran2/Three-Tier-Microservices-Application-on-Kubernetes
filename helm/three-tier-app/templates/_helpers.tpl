...
{{ include "three-tier-app.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "three-tier-app.selectorLabels" -}}
...
*/}}
{{- define "three-tier-app.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "three-tier-app.fullname" .) .Values.serviceAccount.name }}
{{- else }}
